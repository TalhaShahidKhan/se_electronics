    ...
    if (variant === "details") {
      return (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          >
            <CreditCard size={24} />
            <span className="text-[10px] font-black uppercase tracking-widest">Pay Staff</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-widest">Edit Info</span>
          </button>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 0-3 3v6.75a3 3 0 0 0 3 3h.75a.75.75 0 0 1 .75.75v.75a.75.75 0 0 1-.75.75h-1.5A.75.75 0 0 1 15 18.75v-1.5a.75.75 0 0 1 .75-.75h.75a3 3 0 0 0 3-3V8.25a3 3 0 0 0-3-3h-1.5Z" />
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 9.75h.008v.008H10.5V9.75Z" />
            </svg>
            <span className="text-[10px] font-black uppercase tracking-widest">Auth Settings</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-widest">Send Link</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-widest">Download ID</span>
          </a>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.244 2.244 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
            </svg>
            <span className="text-[10px] font-black uppercase tracking-widest">Delete Staff</span>
          </button>
        </div>
      );
    }
