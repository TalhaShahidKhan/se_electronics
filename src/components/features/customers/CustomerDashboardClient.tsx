...
export default function CustomerDashboardClient({
  ...
  const primaryActions = [
    { label: "Home", icon: Home, href: "/customer/profile", color: "text-amber-500", bg: "bg-amber-50" },
    { label: "Online Service", icon: Monitor, href: "/get-service", color: "text-brand", bg: "bg-brand/5" },
    { label: "Subscription", icon: Zap, href: "/maintenance-plans", color: "text-indigo-500", bg: "bg-indigo-50" },
    { label: "Product Service", icon: Settings, href: "/customer/services", color: "text-emerald-500", bg: "bg-emerald-50" },
  ];

  const secondaryActions = [
    { label: "Tracking", icon: Activity, href: "/customer/services", color: "text-blue-500" },
    { label: "Warranty", icon: ShieldCheck, href: "/check-warranty", color: "text-purple-500" },
    { label: "Reports", icon: FileText, href: "/customer/complain/history", color: "text-rose-500" },
    { label: "VIP Card", icon: Crown, href: "/customer/vip-card", color: "text-yellow-600" },
    { label: "Feedback", icon: Star, href: "/customer/services", color: "text-pink-500" },
    { label: "Support", icon: PhoneCall, href: `tel:${adminPhone}`, color: "text-brand" },
    { label: "Coverage", icon: MapPin, href: "/coverage", color: "text-cyan-600" },
      ...
      <div className="flex flex-col gap-6 p-4 sm:p-6 text-gray-800 pb-24">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between gap-4 relative z-10">
                <div className="flex-1 min-w-0">
                    ...
                    <h2 className="text-2xl sm:text-4xl font-black text-gray-900 truncate mb-1">{customer.name}</h2>
            ...
            <div className="mt-6 flex flex-wrap gap-4 text-sm font-bold">
                ...
                <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100 flex items-center gap-3 flex-1 min-w-[200px]">
                    ...
                    <span className="text-gray-600 truncate">{customer.address || "No address provided"}</span>
                </div>
            </div>
        </div>
        ...
        <div className="hidden sm:block bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-xs font-black text-brand uppercase tracking-[0.25em]">Main Tools</h3>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-8 sm:hidden">
            <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Quick Actions</h3>
