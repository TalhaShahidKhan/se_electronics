            ...
            <button
              ...
              className={clsx(
                ...
                task.status === "completed"
                  ...
                  : "border-brand/10 shadow-md hover:shadow-lg hover:border-brand/30",
              )}
            >
              {/* Priority Indicator */}
              <div
            ...
            <div className="pt-4 border-t border-gray-100 flex flex-wrap gap-3">
              ...
              {selectedTask.status === "in_progress" && (
                <button
                  disabled={isUpdatingStatus}
                  onClick={() =>
                    handleStatusUpdate(selectedTask.taskId, "completed")
                  }
                  className="flex-1 min-w-[140px] py-4 rounded-md bg-emerald-600 text-white font-black uppercase tracking-widest text-xs hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100 flex items-center justify-center gap-2"
                >
