            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center flex-1">
                ...
                <div className="relative w-full lg:max-w-xs">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-none rounded-xl text-base focus:ring-2 focus:ring-brand/20 transition-all outline-none" 
                    />
                </div>
                ...
                <button 
                    ...
                    className="flex items-center justify-center gap-2 hover:bg-gray-50 text-gray-600 rounded-xl px-4 py-2.5 text-base font-medium transition-colors border border-gray-100 sm:border-none"
                >
                    <svg
            ...
            <div className="flex flex-wrap items-center gap-4 lg:gap-6 pt-3 lg:pt-0 border-t lg:border-none border-gray-50">
                ...
                <div className="flex items-center gap-4 ml-auto sm:ml-0">
                    <div className="flex items-center gap-2 text-sm sm:text-base font-medium text-gray-500">
                        ...
                        <span className="text-gray-900 bg-gray-100 px-2 py-1 rounded-lg font-bold">{pagination.totalRecords}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-sm sm:text-base font-medium text-gray-500">
                        ...
                        <select 
                            ...
                            className="bg-gray-100 border-none rounded-lg text-sm font-bold h-9 px-2 outline-none focus:ring-2 focus:ring-brand/20"
                        >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1.5">
                            <button 
                                ...
                                className="p-2 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:hover:bg-gray-100 rounded-lg transition-all"
                            >
                                {pendingDirection === 'left' ? <Loader2 className="text-brand animate-spin size-5" /> : <ChevronLeft className="text-gray-700 size-5" />}
                            </button>
                            <button 
                                ...
                                className="p-2 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 disabled:hover:bg-gray-100 rounded-lg transition-all"
                            >
                                {pendingDirection === 'right' ? <Loader2 className="text-brand animate-spin size-5" /> : <ChevronRight className="text-gray-700 size-5" />}
                            </button>
                        </div>
                    </div>
                </div>
