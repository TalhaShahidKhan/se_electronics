        ...
        {isLoading ? (
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-24 bg-gray-100 animate-pulse rounded-3xl"
              />
            ))}
          </div>
              ...
              return (
                <div
                  ...
                  className={clsx(
                    ...
                    isNew
                      ? "border-brand/20 shadow-lg shadow-brand/5 ring-1 ring-brand/5"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {n.link && (
                          <Link
                            href={n.link}
                            className="inline-flex items-center gap-1.5 text-sm font-black text-brand uppercase tracking-widest hover:underline"
                          >
                        ...
                        {isNew && (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 text-sm font-black text-emerald-600 uppercase tracking-widest hover:underline"
                          >
