    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="py-6 px-3 sm:px-4 flex justify-center flex-1">
        <div className="w-full max-w-5xl">
          <div className="hidden md:flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 bg-white p-4 rounded-md border border-gray-200 shadow-sm">
            <Link
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-brand text-white px-4 py-2 rounded-md font-bold text-sm shadow-md transition-all hover:bg-brand/90"
              >
                <Download size={16} />
                Complaint Doc
              </Link>
              {isHearing && (
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-amber-600 text-white px-4 py-2 rounded-md font-bold text-sm shadow-md transition-all hover:bg-amber-700"
                >
                  <Download size={16} />
                  Hearing Notice
                </Link>
              ...
              <div className="space-y-12">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 relative group">
                  ...
                  <div className="flex-1 flex items-center gap-4 w-full">
                    ...
                    <div className="flex-1 bg-emerald-50/50 border border-emerald-100 rounded-md p-5 group-hover:bg-emerald-50 transition-colors">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 relative group">
                  ...
                  <div className="flex-1 flex items-center gap-4 w-full">
                    ...
                    ></div>
                    <div
                      className={`flex-1 border rounded-md p-5 transition-all ${isProcessing ? "bg-emerald-50/50 border-emerald-100 group-hover:bg-emerald-50" : "bg-gray-50 border-gray-100 opacity-60"}`}
                    >
                      <h4
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 relative group">
                  ...
                  <div className="flex-1 flex items-center gap-4 w-full">
                    ...
                    ></div>
                    <div
                      className={`flex-1 border rounded-md p-5 transition-all ${isHearing ? "bg-emerald-50/50 border-emerald-100 group-hover:bg-emerald-50" : "bg-gray-50 border-gray-100 opacity-60"}`}
                    >
                      <h4
          ...
          <div className="bg-white rounded-sm pt-12 pb-20 px-10 sm:px-16 md:px-24 mb-10 text-black font-serif shadow-sm border border-gray-300 print:shadow-none print:border-none min-h-[1056px] relative mx-auto w-full max-w-[800px] text-sm md:text-base leading-relaxed">
            ...
            <div className="mb-8">
              ...
              <p className="text-justify leading-loose tracking-wide whitespace-pre-wrap">
                ...
                আপনার একজন কাস্টমার। {complaint.subject} - এই বিষয়ের ভিত্তিতে
                আমি এই অভিযোগ দায়ের করছি।
                <br />
                <br />
                {complaint.description}
                <br />
                <br />
                এমতবস্থায় টেকনিশিয়ান নামঃ {complaint.staff?.name} এর জন্য
                আপনাদের স্বনামধন্য কোম্পানী এস ই ইলেকট্রনিক্স এর সম্মান ক্ষুন্ন
                হয়েছে। ও আমি তাহার এই আচরণের জন্য এস ই ইলেকট্রনিক্স এর
                মহাপরিচালক / চেয়ারম্যান, এর কাছে এই বিষয়ে সঠিক যাচাই বাছাই করে
                বিচারের জন্য জোর আবেদন করছি।
              </p>
            </div>
