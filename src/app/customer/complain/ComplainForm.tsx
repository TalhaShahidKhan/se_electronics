...
export default function ComplainForm({
    ...
    return (
      <div className="bg-white rounded-3xl shadow-sm border border-emerald-100 p-12 flex flex-col items-center justify-center gap-4 text-center">
        ...
        <p className="text-gray-600 text-lg">
          We received your complaint. Redirecting to profile...
        </p>
      </div>
    );
  }
  ...
  return (
    <form
      action={action}
      className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 flex flex-col gap-6 w-full"
    >
      <input type="hidden" name="customerId" value={customerId} />
      ...
      <div className="flex flex-col gap-2">
        ...
        <select
          name="staffId"
          required
          className="w-full p-4 border border-gray-200 rounded-2xl outline-none focus:ring-2 focus:ring-rose-500 bg-gray-50"
        >
          <option value="">-- Choose a staff member --</option>
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          className="w-full p-4 border border-gray-200 rounded-2xl outline-none focus:ring-2 focus:ring-rose-500 bg-gray-50 resize-none"
        ></textarea>
      </div>
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full mt-4 bg-rose-600 hover:bg-rose-700 text-white font-bold py-5 rounded-2xl shadow-lg transition-all disabled:bg-rose-300"
      >
        {isPending ? "Submitting..." : "Submit Complaint"}
      </button>
    </form>
