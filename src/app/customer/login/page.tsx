...
export default function CustomerLoginPage() {
    const [state, loginAction, isPending] = useActionState(customerLogin, undefined);
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-100">
                <div className="text-center mb-8">
                    <div className="flex justify-center mb-4">
                        <Image src='/logo.jpg' alt="Logo" width={100} height={100} className="rounded-lg" />
                    </div>
                    <h1 className="text-2xl font-bold text-gray-800">Customer Login</h1>
                    <p className="text-sm text-gray-500 mt-2">Access your service history and track progress</p>
                </div>

                <form action={loginAction} className="space-y-6" onSubmit={handleSubmit}>
                    <div>
                ...
                <div className="mt-8 text-center text-xs text-gray-400">
                    ...
                    <p className="mt-2 italic">If you haven't set a password yet, please contact our support.</p>
                </div>
            </div>
        </div>
    );
