...
export default async function TechniciansPage({
    ...
    if (searchQuery) {
        ...
        staffs = staffs.filter((staff: any) =>
            ...
            (staff.skills && JSON.parse(staff.skills || '[]').some((s: string) => s.toLowerCase().includes(query)))
        );
    }

    const title = roleFilter === 'technician' ? 'Technicians' : roleFilter === 'electrician' ? 'Electricians' : 'Our Team';
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg">Find the right expert for your service needs</p>
                </div>
                ...
                {staffs.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {staffs.map((staff: any) => (
                            <div key={staff.staffId} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center gap-1 mb-3">
                                        ...
                                        <span className="text-gray-600 text-sm">({staff.rating || 0} rating)</span>
                                    </div>
                                    ...
                                    <p className="text-gray-600 mb-2">
                                        <strong>Experience:</strong> {staff.hasRepairExperience && staff.repairExperienceYears ||
                                            staff.installationExperienceYears || 0} years
                                    </p>
                                    {staff.skills && (
                                        <div className="mb-4">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {(() => {
                                                    try {
                                                        const skills = typeof staff.skills === 'string'
                                                        ...
                                                        return <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-xs">General</span>;
                                                    }
                                                })()}
                                            </div>
                                        </div>
                ...
                <div className="mt-12 text-center text-sm text-gray-500">
                    <p>Need help? Contact us at <a href="tel:+8801310673600" className="text-blue-600">+8801310673600</a> or <a href="mailto:seipsbd@gmail.com" className="text-blue-600">seipsbd@gmail.com</a></p>
                </div>
            </div>
        </div>
    );
