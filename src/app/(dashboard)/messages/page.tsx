    ...
    <div className="flex flex-col gap-6 p-4 max-w-7xl mx-auto">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex bg-white p-1 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-bold transition-all ${filter === "pending" ? "bg-blue-500 text-white" : "text-gray-500 hover:bg-gray-50"}`}
          >
            Unread
          </button>
          <button
            onClick={() => setFilter("replied")}
            className={`px-4 py-2 rounded-xl text-sm font-bold transition-all ${filter === "replied" ? "bg-green-500 text-white" : "text-gray-500 hover:bg-gray-50"}`}
          >
            Replied
          </button>
        </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-4 bg-white rounded-2xl border border-gray-100 shadow-sm outline-none focus:ring-2 focus:ring-blue-500 transition-all"
          value={searchQuery}
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-100">
                {!msg.isRead ? (
                  <button
                    ...
                    className="w-full py-3 bg-blue-600 rounded-xl text-sm font-bold text-white shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all flex items-center justify-center gap-2"
                  >
                    <Reply size={16} />
                    Reply to Message
                  </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="p-8 overflow-y-auto flex-1">
              ...
              <textarea
                className="w-full h-40 p-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 transition-all"
