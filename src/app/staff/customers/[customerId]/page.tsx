                    ...
                    <div className="space-y-4 pt-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-black text-gray-900">{customer.phone}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">Installation Address</p>
                                <p className="text-xs font-bold text-gray-700 leading-relaxed">{customer.address}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-gray-400 uppercase tracking-tighter">Joined Since</p>
                                <p className="text-sm font-black text-gray-900">{formatDate(customer.createdAt)}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 min-h-[400px]">
                    ...
                    {customer.invoice ? (
                        <div className="space-y-4">
                             <div className="p-5 rounded-2xl border border-gray-100 bg-gray-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="space-y-1">
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Primary Invoice</p>
                                    <p className="text-sm font-black text-gray-900">{customer.invoice.invoiceNumber}</p>
                                    <p className="text-xs text-gray-500 font-bold uppercase tracking-tight">{customer.invoice.paymentType} • Total: ৳{customer.invoice.total}</p>
                                </div>
                                <Link 
                                    href={`/staff/payment/${customer.invoice.invoiceNumber}`}
                                    className="px-5 py-2.5 rounded-xl bg-white text-gray-900 text-xs font-black shadow-sm border border-gray-200 flex items-center gap-2 hover:bg-gray-50 transition-all active:scale-95"
                                >
                        ...
                        <div className="h-48 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-sm font-bold text-gray-400">No service history found for this customer.</p>
                        </div>
                    )}

                    <div className="mt-8 pt-8 border-t border-gray-50">
                        <p className="text-[10px] font-black text-gray-300 uppercase tracking-[0.2em] mb-4">Account Status</p>
                        <div className="flex gap-4">
                            ...
                            <div className="flex-1 p-4 rounded-2xl bg-brand/5 border border-brand/10">
                                <p className="text-[10px] font-black text-brand uppercase mb-1">Balance</p>
                                <p className="text-sm font-black text-gray-900">৳{customer.invoice?.dueAmount || 0} DUE</p>
                            </div>
                        </div>
                    </div>
                </div>
