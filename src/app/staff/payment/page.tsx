...
import { CreditCard, Settings, Wallet, ChevronRight, Download, Eye, ChevronLeft } from "lucide-react";
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-3 lg:gap-4">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h2 className="font-black text-gray-900 lg:text-lg text-sm">Settings</h2>
                <p className="hidden lg:block text-xs sm:text-sm font-bold text-gray-400 mt-1 truncate">
                  Configure Wallet
                </p>
              </div>
              <ChevronRight className="text-gray-300 group-hover:text-brand transition-colors hidden lg:block" size={20} />
            </Link>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h2 className="font-black text-gray-900 lg:text-lg text-sm">Withdraw</h2>
                <p className="hidden lg:block text-xs sm:text-sm font-bold text-gray-400 mt-1 truncate">
                  Request Payout
                </p>
              </div>
              <ChevronRight className="text-gray-300 group-hover:text-teal-600 transition-colors hidden lg:block" size={20} />
            </Link>
          </div>
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      <span className="font-black text-gray-700 lg:text-lg">
                        {payment.invoiceNumber.startsWith('BAL-') ? "BAL#" + payment.paymentId.substring(0, 8) : "SFC#" + payment.invoiceNumber}
                      </span>
                      <span
                        className={clsx(
